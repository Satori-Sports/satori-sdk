...
export interface RoyaltiesInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "ROYALTIES_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getRoyaltiesDetails",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getRoyaltiesOwed",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "grantRoyaltiesTo",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "recordRoyalties",
  ...
  encodeFunctionData(
    functionFragment: "royaltiesOwed",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type RoyaltiesRecordedEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  RoyaltiesRecordedEventObject
>;

export type RoyaltiesRecordedEventFilter =
  TypedEventFilter<RoyaltiesRecordedEvent>;
...
export interface Royalties extends BaseContract {
  ...
  filters: {
    ...
    "RoyaltiesRecorded(address,uint256,uint256)"(
      entity?: null,
      paymentDaySlot?: null,
      totalUSDCPaid?: null
    ): RoyaltiesRecordedEventFilter;
    RoyaltiesRecorded(
      entity?: null,
      paymentDaySlot?: null,
      totalUSDCPaid?: null
