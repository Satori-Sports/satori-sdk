...
exports.TokenCollectibles721__factory = void 0;
...
class TokenCollectibles721__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, TokenCollectibles721__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
...
exports.TokenCollectibles721__factory = TokenCollectibles721__factory;
TokenCollectibles721__factory.bytecode = _bytecode;
TokenCollectibles721__factory.abi = _abi;
