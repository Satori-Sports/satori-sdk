...
export interface TokenCollectibles721Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "hasPendingOwnershipOf",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintMultipleTokens",
    values: [PromiseOrValue<string>, PromiseOrValue<string>[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "royaltiesConfig",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type TokenPurchased721Event = TypedEvent<
  [string, BigNumber, boolean],
  TokenPurchased721EventObject
>;

export type TokenPurchased721EventFilter =
  TypedEventFilter<TokenPurchased721Event>;
...
export interface TokenCollectibles721 extends BaseContract {
  ...
  functions: {
    ...
    purchaseToken(
      ...
      _pending: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "TokenPurchased721(address,uint256,bool)"(
      wallet?: null,
      tokenId?: null,
      pending?: null
    ): TokenPurchased721EventFilter;
    TokenPurchased721(
      wallet?: null,
      tokenId?: null,
      pending?: null
