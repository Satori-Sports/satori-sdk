...
export interface TokenFactory1155Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createToken" | "token1155Implementation"): FunctionFragment;
    encodeFunctionData(functionFragment: "createToken", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "token1155Implementation", values?: undefined): string;
    decodeFunctionResult(functionFragment: "createToken", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "token1155Implementation", data: BytesLike): Result;
    events: {
...
export interface TokenFactory1155 extends BaseContract {
    ...
    populateTransaction: {
        ...
        token1155Implementation(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
