...
export interface TokenRoyaltiesInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getCostPerToken" | "owner" | "pendingPayments" | "renounceOwnership" | "royalties" | "royaltyInfo" | "supportsInterface" | "transferOwnership" | "transferPendingToken"): FunctionFragment;
